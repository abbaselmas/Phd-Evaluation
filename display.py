            ...
            for c3 in range(2): # Normalization Type 0: L2 1: Hamming
                for m in range(2): # Matcher 0: BruteForce 1: FlannBased
                    ...
                    if not (np.isnan(Rate_Graf).any()):
                        fig4trace_Graf   = go.Scatter(x = xvals, y=Rate_Graf,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=True)
                        fig4.add_trace(fig4trace_Graf, row=1, col=1)
                    if not (np.isnan(Rate_Bikes).any()):
                        fig4trace_Bikes  = go.Scatter(x = xvals, y=Rate_Bikes,  mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Bikes, row=1, col=2)
                    if not (np.isnan(Rate_Boat).any()):
                        fig4trace_Boat   = go.Scatter(x = xvals, y=Rate_Boat,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Boat, row=1, col=3)
                    if not (np.isnan(Rate_Leuven).any()):
                        fig4trace_Leuven = go.Scatter(x = xvals, y=Rate_Leuven, mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Leuven, row=2, col=1)
                    if not (np.isnan(Rate_Wall).any()):
                        fig4trace_Wall   = go.Scatter(x = xvals, y=Rate_Wall,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Wall, row=2, col=2)
                    if not (np.isnan(Rate_Trees).any()):
                        fig4trace_Trees  = go.Scatter(x = xvals, y=Rate_Trees,  mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Trees, row=2, col=3)
                    if not (np.isnan(Rate_Bark).any()):
                        fig4trace_Bark   = go.Scatter(x = xvals, y=Rate_Bark,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Bark, row=3, col=1)
                    if not (np.isnan(Rate_Ubc).any()):
                        fig4trace_Ubc    = go.Scatter(x = xvals, y=Rate_Ubc,    mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
                        fig4.add_trace(fig4trace_Ubc, row=3, col=2)
                    fig4trace_overall = go.Scatter(x = xvals, y=np.nanmean([Rate_Graf, Rate_Bikes, Rate_Boat, Rate_Leuven, Rate_Wall, Rate_Trees, Rate_Bark, Rate_Ubc], axis=0), mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig4, legendgroup=legend_groupfig4, showlegend=False)
            ...
            for c3 in range(2): # Normalization Type 0: L2 1: Hamming
                for m in range(2): # Matcher 0: BruteForce 1: FlannBased
                    ...
                    if not (np.isnan(Rate_Graf_x).any()) and not (np.isnan(Rate_Graf_y).any()):
                        fig5trace_Graf   = go.Scatter(x=Rate_Graf_x,   y=Rate_Graf_y,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=True)
                        fig5.add_trace(fig5trace_Graf, row=1, col=1)
                    if not (np.isnan(Rate_Bikes_x).any()) and not (np.isnan(Rate_Bikes_y).any()):
                        fig5trace_Bikes  = go.Scatter(x=Rate_Bikes_x,  y=Rate_Bikes_y,  mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                        fig5.add_trace(fig5trace_Bikes, row=1, col=2)
                    if not (np.isnan(Rate_Boat_x).any()) and not (np.isnan(Rate_Boat_y).any()):
                        fig5trace_Boat   = go.Scatter(x=Rate_Boat_x,   y=Rate_Boat_y,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                        fig5.add_trace(fig5trace_Boat, row=1, col=3)
                    if not (np.isnan(Rate_Leuven_x).any()) and not (np.isnan(Rate_Leuven_y).any()):
                        fig5trace_Leuven = go.Scatter(x=Rate_Leuven_x, y=Rate_Leuven_y, mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                        fig5.add_trace(fig5trace_Leuven, row=2, col=1)
                    if not (np.isnan(Rate_Wall_x).any()) and not (np.isnan(Rate_Wall_y).any()):
                        fig5trace_Wall   = go.Scatter(x=Rate_Wall_x,   y=Rate_Wall_y,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                        fig5.add_trace(fig5trace_Wall, row=2, col=2)
                    if not (np.isnan(Rate_Trees_x).any()) and not (np.isnan(Rate_Trees_y).any()):
                        fig5trace_Trees  = go.Scatter(x=Rate_Trees_x,  y=Rate_Trees_y,  mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                        fig5.add_trace(fig5trace_Trees, row=2, col=3)
                    if not (np.isnan(Rate_Bark_x).any()) and not (np.isnan(Rate_Bark_y).any()):
                        fig5trace_Bark   = go.Scatter(x=Rate_Bark_x,   y=Rate_Bark_y,   mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                        fig5.add_trace(fig5trace_Bark, row=3, col=1)
                    if not (np.isnan(Rate_Ubc_x).any()) and not (np.isnan(Rate_Ubc_y).any()):
                        fig5trace_Ubc    = go.Scatter(x=Rate_Ubc_x,    y=Rate_Ubc_y,    mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
                    ...
                    fig5trace_overall = go.Scatter( x=np.nanmean([Rate_Graf_x, Rate_Bikes_x, Rate_Boat_x, Rate_Leuven_x, Rate_Wall_x, Rate_Trees_x, Rate_Bark_x, Rate_Ubc_x], axis=0),
                                                    ...
                                                    mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=legend_groupfig5, legendgroup=legend_groupfig5, showlegend=False)
            ...
            for c3 in range(2): # Normalization Type 0: L2 1: Hamming
                for m in range(2): # Matcher 0: BruteForce 1: FlannBased
                    ...
                    if not (np.isnan(Rate_dr).any()):
                        fig7trace_Drone  = go.Scatter(x=xvals, y=Rate_dr, mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=f'{DetectorsLegend[i]}-{DescriptorsLegend[j]}-{Norm[c3]}-{Matcher[m]}', showlegend=True)
            ...
            for c3 in range(2): # Normalization Type 0: L2 1: Hamming
                for m in range(2): # Matcher 0: BruteForce 1: FlannBased
                    ...
                    if not (np.isnan(Rate_dr_x).any()) and not (np.isnan(Rate_dr_y).any()):
                        fig8trace_Drone  = go.Scatter(x=Rate_dr_x, y=Rate_dr_y, mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=f'{DetectorsLegend[i]}-{DescriptorsLegend[j]}-{Norm[c3]}-{Matcher[m]}', showlegend=True)
            ...
            for c3 in range(2): # Normalization Type 0: L2 1: Hamming
                for m in range(2): # Matcher 0: BruteForce 1: FlannBased
                    ...
                    if not (np.isnan(Rate_u).any()):
                        fig10trace_UAV  = go.Scatter(x=xvals, y=Rate_u, mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=f'{DetectorsLegend[i]}-{DescriptorsLegend[j]}-{Norm[c3]}-{Matcher[m]}', showlegend=True)
            ...
            for c3 in range(2): # Normalization Type 0: L2 1: Hamming
                for m in range(2): # Matcher 0: BruteForce 1: FlannBased
                    ...
                    if not (np.isnan(Rate_u_x).any()) and not (np.isnan(Rate_u_y).any()):
                        fig11trace_UAV  = go.Scatter(x=Rate_u_x, y=Rate_u_y, mode='lines+markers', marker_symbol=raw_symbols[color_index%56], marker_size=7, line=dict(color=color, dash=style), name=f'{DetectorsLegend[i]}-{DescriptorsLegend[j]}-{Norm[c3]}-{Matcher[m]}', showlegend=True)
